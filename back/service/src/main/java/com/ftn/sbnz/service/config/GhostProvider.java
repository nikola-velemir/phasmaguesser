...
public class GhostProvider {
    private static List<Ghost> GHOSTS = List.of(
            ...
            new Ghost("Wraith", Set.of(Evidence.EMF_LEVEL_5, Evidence.ULTRAVIOLET, Evidence.SPIRIT_BOX),
                    Set.of("No_Salt_Footprints")),
            new Ghost("Phantom", Set.of(Evidence.ULTRAVIOLET, Evidence.GHOST_ORB, Evidence.SPIRIT_BOX),
                    Set.of("Photo_Disappearance")),
            new Ghost("Poltergeist", Set.of(Evidence.ULTRAVIOLET, Evidence.GHOST_WRITING, Evidence.SPIRIT_BOX),
                    Set.of("Multi_Object_Throw")),
            new Ghost("Banshee", Set.of(Evidence.ULTRAVIOLET, Evidence.GHOST_ORB, Evidence.DOTS_PROJECTOR),
                    Set.of("Parabolic_Scream")),
            new Ghost("Jinn", Set.of(Evidence.EMF_LEVEL_5, Evidence.ULTRAVIOLET, Evidence.FREEZING_TEMPERATURES),
                    Set.of("Speed_Increase_With_Fuse_Box")),
            new Ghost("Mare", Set.of(Evidence.GHOST_ORB, Evidence.GHOST_WRITING, Evidence.SPIRIT_BOX),
                    Set.of("Attack_In_Darkness")),
            new Ghost("Revenant", Set.of(Evidence.GHOST_ORB, Evidence.GHOST_WRITING, Evidence.FREEZING_TEMPERATURES),
                    Set.of("High_Hunt_Speed")),
            new Ghost("Shade", Set.of(Evidence.EMF_LEVEL_5, Evidence.GHOST_WRITING, Evidence.FREEZING_TEMPERATURES),
                    Set.of("Shy_In_Presence")),
            new Ghost("Demon", Set.of(Evidence.ULTRAVIOLET, Evidence.GHOST_WRITING, Evidence.FREEZING_TEMPERATURES),
                    Set.of("Early_Hunt_And_Low_Cooldown")),
            new Ghost("Yurei", Set.of(Evidence.GHOST_ORB, Evidence.FREEZING_TEMPERATURES, Evidence.DOTS_PROJECTOR),
                    Set.of("Door_Manipulation")),
            new Ghost("Oni", Set.of(Evidence.EMF_LEVEL_5, Evidence.FREEZING_TEMPERATURES, Evidence.DOTS_PROJECTOR),
                    Set.of("High_Activity_Near_Player")),
            new Ghost("Yokai", Set.of(Evidence.GHOST_ORB, Evidence.SPIRIT_BOX, Evidence.DOTS_PROJECTOR),
                    Set.of("Voice_Sensitivity")),
            ...
            new Ghost("Onryo", Set.of(Evidence.GHOST_ORB, Evidence.FREEZING_TEMPERATURES, Evidence.SPIRIT_BOX),
                    Set.of("Candle_Extinguish_Trigger")),
            new Ghost("The Twins", Set.of(Evidence.EMF_LEVEL_5, Evidence.FREEZING_TEMPERATURES, Evidence.SPIRIT_BOX),
                    Set.of("Dual_Interactions")),
            new Ghost("Raiju", Set.of(Evidence.EMF_LEVEL_5, Evidence.GHOST_ORB, Evidence.DOTS_PROJECTOR),
                    Set.of("Electronics_Speed_Boost")),
            ...
            new Ghost("The Mimic",
                    Set.of(Evidence.ULTRAVIOLET, Evidence.FREEZING_TEMPERATURES, Evidence.SPIRIT_BOX,
                            Evidence.GHOST_ORB),
                    Set.of("Copy_Other_Ghosts")),
